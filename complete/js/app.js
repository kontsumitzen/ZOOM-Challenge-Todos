(function () {
    ...
    function spanShareClickHandler(todo) {
        //shareTodo(event.target.getAttribute('data-todo-id'));
        console.log('sharing');
        shareTextMockingSelection(todo);                   
    }
	...
	function redrawTodosUI() {
		...
		for (i = 0, l = todos.length; i < l; i++) {
            ...
            shareLink.className = 'share';
            shareLink.setAttribute('data-todo-id', todo.id);
            shareLink.addEventListener('click', function(){
                spanShareClickHandler(todo.title);
             });
            ...
            divDisplay.appendChild(shareLink);
